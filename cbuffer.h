...
int cbuf_offer(cbuf_t *cb, const char *data, const int size);
...
char *cbuf_peek(const cbuf_t *cb);
...
char *cbuf_poll(cbuf_t *cb, const unsigned int size);
 ...
 * @return char*
 */
const char *cbuf_serialize(const cbuf_t *cb);
 ...
 * @return
 */
cbuf_t *cbuf_deserialize(const char *bf);
